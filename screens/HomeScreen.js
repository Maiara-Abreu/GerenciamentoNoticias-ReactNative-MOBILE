...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <ImageBackground
        source={{ uri: 'https://th.bing.com/th/id/R.8e9803a9dd1899557e8df63bd05d19ce?rik=6zABYs2trzbsPg&pid=ImgRaw&r=0' }}
        style={styles.backgroundImage}
      >
        <View style={styles.overlay}>
          <Text style={styles.headerText}>Como eu vim parar aqui? </Text>
        </View>
      </ImageBackground>

      <View style={styles.aboutContainer}>
        <Text style={styles.sectionTitle}>Sobre Maiara Abreu</Text>
      ...
      <View style={styles.socialContainer}>
        ...
        <View style={styles.socialButtons}>
          ...
          <TouchableOpacity
            ...
            onPress={() => openLink('https://www.linkedin.com/in/maiara-abreu-da-silva-915340294/')}
          >
